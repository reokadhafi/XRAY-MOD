...
cd
#install tools/alat
wget https://raw.githubusercontent.com/reokadhafi/XRAY-MOD/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray
wget https://raw.githubusercontent.com/reokadhafi/XRAY-MOD/main/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh
#install xmenu

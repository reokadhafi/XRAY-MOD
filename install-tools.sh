...
# ==================================================
# Link Hosting Kalian
#akbarvpn="biznet.reonolimits.my.id"
akbarvpn=$(cat /root/domain)
#
cd
...
sed -i 's|listen = /var/run/php/php8.1-fpm.sock|listen = 127.0.0.1:9000|g' /etc/php/8.1/fpm/pool.d/www.conf
useradd -m vps;
